...
#define _DUTY_MAX 3000 // 3000
#define _DUTY_NEU 2050 // 2050
#define _DUTY_MIN 50 // 50

#define _SERVO_ANGLE_DIFF  2950  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 623+-2*a_value+1.62E-03*a_value*a_value;
}
